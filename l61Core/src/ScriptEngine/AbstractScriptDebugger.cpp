...
namespace l61
{
    ...
    ScriptEnvironment* AbstractScriptDebugger::getScriptCtx()
    {
        return this->scriptCtx;
    }

    l61_stat& AbstractScriptDebugger::getL61Ctx()
    {
        return this->lstat;
    }

    sol::state& AbstractScriptDebugger::getScriptLuaState()
    {
        return this->getScriptCtx()->getLuaCtx();
    }
}